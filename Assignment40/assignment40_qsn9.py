...
def comaparePerformace():
    ...
    plt.tight_layout()
    plt.savefig("decision_tree_Performance_index.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    print("Previously Feature importance was: Attendance")
    print("Now Feature importance is: ", root_feature)
