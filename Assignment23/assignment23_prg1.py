...
output:
Ramayan by Valmiki. No of books: 1
Panchatantra by Vishnu Sharma. No of books: 2
Mahabharata by Ved Vyas. No of books: 3
"""
...
if __name__ == "__main__":
    Objl = BookStore("Ramayan", "Valmiki")
    Objl.Display()

    Obj2 = BookStore("Panchatantra", "Vishnu Sharma")
    Obj2.Display()

    Obj3 = BookStore("Mahabharata", "Ved Vyas")
    Obj3.Display()
